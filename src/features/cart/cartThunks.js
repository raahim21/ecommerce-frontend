...
// export const fetchServerCart = createAsyncThunk('cart/fetch', async (_, { rejectWithValue }) => {
//   try {
...
// export const addToServerCart = createAsyncThunk('cart/add', async (item, { rejectWithValue }) => {
//   try {
...
// export const updateServerQuantity = createAsyncThunk('cart/update', async ({ variantId, quantity }, { rejectWithValue }) => {
//   try {
...
// export const removeFromServerCart = createAsyncThunk('cart/remove', async (variantId, { rejectWithValue }) => {
//   try {
//     await fetch(`${API}/api/cart/${variantId}`, { method: 'DELETE', credentials: 'include' });
//     const res = await fetch(`${API}/api/cart`, { credentials: 'include' });
//     const { cart } = await res.json();
//     return cart;
//   } catch {
...
//   'cart/swapVariant',
//   async ({ oldVariantId, newVariant, quantity, productId }, { rejectWithValue }) => {
//     try {
...
//           quantity,
//           productId: productId || newVariant.productId,
//         }),
//       });
//       if (!res.ok) {
...
// export const mergeLocalToServer = createAsyncThunk('cart/merge', async (_, { getState }) => {
//   const local = JSON.parse(localStorage.getItem('guestCart') || '[]');
//   if (!local.length) return;
//   await Promise.all(
//     local.map(item => fetch(`${API}/api/cart`, {
//       method: 'POST',
//       credentials: 'include',
//       headers: { 'Content-Type': 'application/json' },
//       body: JSON.stringify(item),
